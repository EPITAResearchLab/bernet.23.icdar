...
int ag3line(Mat& im,vector<lineag>& lines,bool control,const ag3line_parameters& params)
{
	float gradt =params.gradt;
	int initialSize =params.initialSize;
	float ang_th =params.ang_th;
	int maxitera = params.maxitera; 
